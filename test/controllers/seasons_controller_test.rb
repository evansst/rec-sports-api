...
class SeasonsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create season" do
    assert_difference('Season.count') do
      post seasons_url, params: { season: { end_date: @season.end_date, start_date: @season.start_date } }, as: :json
    end
  ...
  test "should update season" do
    patch season_url(@season), params: { season: { end_date: @season.end_date, start_date: @season.start_date } }, as: :json
    assert_response 200
  end
